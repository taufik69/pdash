...
const s = {
  ...
  textarea: { width: "100%", background: "var(--background)", border: "1px solid var(--border)", borderRadius: 8, padding: "12px 14px", fontSize: 14, color: "var(--foreground)", outline: "none", resize: "none", minHeight: 140, lineHeight: 1.6, transition: "border-color 0.2s", fontWeight: 500 },
  ...
  previewImg: { width: 120, height: 120, objectFit: "cover", borderRadius: 12, border: "1px solid var(--border)", boxShadow: "0 4px 12px rgba(0,0,0,0.08)" },
