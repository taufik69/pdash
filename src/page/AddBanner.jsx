...
const s = {
  ...
  dropText: { fontSize: 14, color: "#9ca3af", margin: 0 },
  ...
  previewInfo: { display: "flex", flexDirection: "column", gap: 4, flex: 1 },
  ...
  toast: { display: "flex", alignItems: "center", gap: 10, padding: "12px 16px", borderRadius: 10, border: "1px solid", fontSize: 13, minWidth: 260 },
  toastIcon: { width: 18, height: 18, borderRadius: "50%", display: "flex", alignItems: "center", justifyCenter: "center", fontSize: 10, background: "rgba(255,255,255,0.1)" },
  toastMsg: { flex: 1 },
  toastClose: { background: "none", border: "none", fontSize: 16, cursor: "pointer", opacity: 0.7 },
};
