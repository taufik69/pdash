  ...
  return (
    <div style={s.page}>
      ...
      <div className="ct-stats">
        <StatCard icon={Tag} label="Total Sub-Categories" value={subcategories.length} accent="#d97706" />
        <StatCard icon={Tag} label="Filtered Results" value={filtered.length} accent="#818cf8" />
        <StatCard icon={Tag} label="No Description" value={subcategories.filter((c) => !c.description).length} accent="#f87171" />
      </div>
...
const s = {
  ...
  parentTag: { display:"inline-block", background:"rgba(99, 102, 241, 0.12)", padding:"4px 8px", borderRadius:6, color:"#818cf8", fontSize:11, fontWeight:600 },
